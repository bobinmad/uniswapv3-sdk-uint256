...
func initPool() (*Pool, int32, uint16) {
	...
	pool := NewPoolV3(common.Address{}, uint16(constants.FeeLow), poolTickCurrent, poolSqrtRatioStart, DAI, USDC, nil)
...
func TestPosition(t *testing.T) {
	...
	assert.ErrorIs(t, err, ErrTickLowerTickSpacing)
...
func TestMintAmountsWithSlippage(t *testing.T) {
	...
	minPricePool := NewPoolV3(common.Address{}, uint16(constants.FeeLow), utils.MinTick, utils.MinSqrtRatioU256, DAI, USDC, nil)
	...
	maxPricePool := NewPoolV3(common.Address{}, uint16(constants.FeeLow), utils.MaxTick-1, new(uint256.Int).Sub(utils.MaxSqrtRatioU256, uint256.NewInt(1)), DAI, USDC, nil)
